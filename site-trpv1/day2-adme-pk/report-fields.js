...
window.REPORT_FIELDS = [
  ...
  {
    prefix: "d2t3", label: "Compound screening decisions", type: "verdict-table",
    dataGlobal: "TASK3_DATA", idKey: "ID", nameKeys: ["ID", "Series"]
  },
  { qid: "d2t3-assay-rationale", label: "Why might the PK parameters used here matter in the context of this drug target?", type: "text" },
  { qid: "d2t3-sar", label: "What obvious structure–activity relationships emerge from the data?", type: "text" },
  { qid: "d2t3-cdtp-changes", label: "Has anything here changed your CDTP? If so, how?", type: "text" },
