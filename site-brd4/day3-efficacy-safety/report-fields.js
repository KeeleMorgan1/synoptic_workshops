/* report-fields.js — Day 3 report layout (BRD4). */
window.REPORT_FIELDS = [
  ...
  { qid: "d3t1-graph", label: "Time vs [drug] graphs (linear and log axes)", type: "image" },
  {
    ...
    rows: ["A02", "B18", "C05", "D02", "D04", "D16", "D18", "D19", "D20", "D21", "D22"],
    columns: [
  ...
  { section: "Task 2 — In Vivo PK & Xenograft Efficacy Screen" },
  {
  ...
  { qid: "d3t4-explain-models", label: "Explanation of in vivo safety endpoints", type: "text" },
  {
