/* report-fields.js — Day 4 (Part 1: Stability) report layout. */
window.REPORT_FIELDS = [
  ...
  { section: "Task 1b — Aqueous Solution Stability (pH-Rate Profile)" },
  { qid: "d4t1b-graph", label: "pH-rate profile plot(s)", type: "image" },
  {
    type: "input-table", label: "Calculated aqueous stability parameters", qidPrefix: "d4t1b", rowLabel: "Compound",
    rows: ["D18", "D19", "D20", "D21", "D22"],
    columns: [
      { key: "optpH", label: "Optimal pH" }, { key: "kopt", label: "k_opt (/h)" },
      { key: "t90h", label: "t90 pH7.4 (h)" }, { key: "t90days", label: "t90 pH7.4 (days)" },
      { key: "classification", label: "Classification" }
    ]
  },
  ...
  { qid: "d4t1c-graph", label: "Degradation plot(s)", type: "image" },
  {
    ...
    rows: ["D18", "D19", "D20", "D21", "D22"],
    columns: [
      { key: "kacid", label: "k_acid (/min)" }, { key: "thalf", label: "t½ (min)" }, { key: "classification", label: "Classification" }
    ]
  },
  ...
  { qid: "d4t1d-graph", label: "Degradation plot(s)", type: "image" },
  {
    ...
    rows: ["D18", "D19", "D20", "D21", "D22"],
    columns: [
      { key: "kphoto", label: "k_photo (Wh/m²)⁻¹" }, { key: "pctrem1200", label: "% remaining @1200 Wh/m²" },
      { key: "classification", label: "Classification" }
    ]
  },
